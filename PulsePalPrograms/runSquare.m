...
StimGenInputVoltage = 1.6;%*sin((2*pi/1000)*(1:1000)); %Range 20V to stimulus generator
IntanInputVoltage = StimGenInputVoltage * 2.5;%*sin((2*pi/1000)*(1:1000)); % Range 4V to intan
...
SendCustomWaveform(1, 0.0005, StimGenInputVoltage); % Uploads sine waveform for stim gen channel. Samples are played at 2khz.
SendCustomWaveform(2, 0.0005, IntanInputVoltage); % Uploads sine waveform for intan channel. Samples are played at 2khz.
